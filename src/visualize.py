...
def plot_loss(his, ds):
    ...
    plt.plot(np.arange(len(his['val_loss'])), his['val_loss'], label='valid loss', marker='o', markersize=3)
    plt.title(ds + ' training loss')
    plt.legend(loc='best')
    plt.savefig('D:/fer/FacialExpressionRecognition/assets/his_loss.png')
...
def plot_acc(his, ds):
    ...
    plt.plot(np.arange(len(his['val_accuracy'])), his['val_accuracy'], label='valid accuracy', marker='o', markersize=3)
    plt.title(ds + ' training accuracy')
    plt.legend(loc='best')
    plt.savefig('D:/fer/FacialExpressionRecognition/assets/his_acc.png')
