...
class LBP(object):
    # use LBP+SVM to realize fer

    def load_image(self, foler):
        """
        read all the refered pictures
        :param foler:
        :return:
        """
    ...
    def get_lbp(self, image):
        """
        After getting the LBP of a given image and dividing it into several regions
        :param rgb:
        :return:
        """
        gridx = 6
...
def evaluate_lbp(data_op=1, op=1, reduction=1, rate=0.2):
    """
    Evaluation function on three data sets
