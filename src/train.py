"""
Training script, as the data set is not large, here a one-time read into memory.
"""
import os
import argparse
...
if opt.dataset == "fer2013":
    ...
    callback = [
        ...
        ModelCheckpoint('D:/fer/FacialExpressionRecognition/models/cnn3_best_weights.h5', monitor='val_accuracy', verbose=True, save_best_only=True,
                        save_weights_only=True)]
