...
class UI(object):
    ...
    def retranslate_ui(self, form):
        ...
        self.label_designer.setText(_translate("Form", "designed by mty"))
        self.pushButton_select_img.setText(_translate("Form", "Choose a picture"))
        self.label_result.setText(_translate("Form", "Result"))
        self.label_emotion.setText(_translate("Form", "null"))
        self.label_bar.setText(_translate("Form", "bar chart of the result"))
    ...
    def show_results(self, emotion, possibility):
        ...
        # 显示emoji
        if emotion != 'no':
            img = cv2.imread('D:/fer/FacialExpressionRecognition/assets/icons/' + str(emotion) + '.png')
