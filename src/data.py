...
class Fer2013(object):
    ...
    def gen_train(self):
        """
        产生训练数据
        :return expressions: the order of reading the file i.e. the subscript of the tag corresponds to
        :return x_train: training data set
        ...
        for i in tqdm(range(len(expressions))):
            ...
            # expression_folder = expression_folder.replace('\\', '/')
            expression_folder = 'D:/fer/FacialExpressionRecognition/'+ folder + '/' + expressions[i]
